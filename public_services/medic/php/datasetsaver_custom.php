<?php
            ...
            if(count($sqlqueryData)>0){
                ...
                if($function == "group_rights_save"){
                    ...
                    foreach($values as $postkey => $value){
                        if(substr($postkey,0,7) == "injury_"){
                            if($value != ""){
                                $injuries[] = ["id" => str_replace("injury_","",$postkey), "value" => $value];        
                            }
                        }
                    }
                    ...
                    $sql = " "
                        ...
                        .") VALUES ("
                            ...
                            .",'".$db->escapeString($values["intensity_of_wounds"])."'"
                            .",'".$db->escapeString($values["type_of_bleeding"])."'"
                            .",'".$db->escapeString($values["treatment"])."'"
                            .",".$db->escapeString($values["need_follow_up_treatment"])
                    ...
                    if(!$success){
                        ...
                        foreach($injuries as $info){
                            if($success){
                                
                                $sql = " "
                                ."INSERT INTO files_entries_injuries("
                                    ."files_entries_uid"
                                    .",injury_at"
                                    .",injury"
                                    .",createdby"
    ...
    function getRandomFileEntryID(){
        global $files_ending;
        return rand(1000,9999).'-'.rand(1000,9999)."-".$files_ending;
    }
